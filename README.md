...
Las mejoras implementadas y presentadas al docente son las siguientes:
...
3. **Calendario semanal de disponibilidad** con horarios libres (verde) y ocupados (rojo)
...
8. **Paciente puede cancelar su propio turno** con motivo registrado
9. **Paciente puede reprogramar su turno** con validación de disponibilidad
10. **Búsqueda por DNI con autocompletado** de nombre, apellido y obra social del paciente
11. **Historial completo del paciente** accesible desde cualquier turno
12. **Agenda semanal del médico** con vista de 7 días ordenada por hora
13. **Dashboard de bienvenida** con resumen del día y próximos turnos
14. **Notificaciones en tiempo real** vía Supabase Realtime — todos los usuarios ven los cambios al instante
15. **Semáforo visual de estado** en tabla y panel de notificaciones
16. **Filtrado estricto por rol** — cada usuario ve solo lo que le corresponde
17. **Diseño responsive para mobile** con sidebar hamburguesa

### Exportación para Estadística

El sistema permite al administrador exportar los datos de turnos a un archivo Excel (.xlsx) seleccionando exactamente qué columnas incluir y aplicando filtros por especialidad, médico, estado y rango de fechas. El archivo incluye entre otras cosas la edad calculada del paciente al momento del turno, calculada automáticamente a partir de la fecha de nacimiento.
